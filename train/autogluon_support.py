...
platform: win
env: any
name: autogluon_support.py
predict on tabular data containing ECIF+LD data and binding data, using autogluon model generator
"""
...
def train_with_autogluon(distance_cutoffs, split_factor, tag):
    ...
    :param tag: for extra tests
    :return: using autogluon leaderboard to demonstrate training result
    """
...
def predict_with_autogluon_by_id(ids, d, model_dir, select_model=None):
    """
    get a prediction on binding affinity of given protein indexes, using autogluon
    :param ids: list of protein indexes
    :param d: distance cutoff, default '6.0'
    :param model_dir: the path to model generated by autogluon, by default it is train/AutogluonModels
    :param select_model: if None, the best model would be used
    :return: a data frame includes actual value and predicted value
    """
    print("\n")
